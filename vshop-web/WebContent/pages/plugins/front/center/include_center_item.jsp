...
<%!
	public static final String MEMBERCENTER_EDIT_URL = "pages/front/center/member/MemberCenterActionFront!editBasePre.action";
...
<ul class="nav nav-pills nav-stacked">									<!-- 定义导航 -->
	...
	<li class="${param.ch == 2 ? "active" : ""}"><a href="<%=MEMBERCENTER_EDIT_URL%>">个人信息</a></li>
